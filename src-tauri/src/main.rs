    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let storage_state = storage::StorageState::new(&vault_path)
                .expect("Failed to init storage DB");
            ...
            // Keep legacy crypto state for modules still wired to core::crypto.
            let legacy_crypto_state = core::crypto::CryptoState::new(&vault_path)
                .expect("Failed to init legacy crypto keystore");
            app.manage(legacy_crypto_state);
